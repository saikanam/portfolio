  ...
  const Component = forwardRef<T, React.HTMLAttributes<T>>((props, ref) => {
    return React.createElement(
      ...
      { 
        ...
        className: cn(
          defaultClassName, 
          // Use simplified focus styles that work with shadcn dark mode
          'typography-focus',
          props.className
        ) 
      },
...
export const InlineCode = createComponent<HTMLSpanElement>(
  'code',
  'relative rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono text-sm font-semibold focus-visible:bg-accent',
  'InlineCode'
);

export const MultilineCode = createComponent<HTMLPreElement>(
  'pre',
  'relative rounded bg-muted p-4 font-mono text-sm font-semibold overflow-x-auto focus-visible:bg-accent',
  'MultilineCode'
);
...
// Interactive Link component with shadcn styling
  ...
  ({ className, ...props }, ref) => (
    <a
      ...
      className={cn(
        ...
        'hover:text-primary/80 focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none',
...
// Interactive Button text component with shadcn styling
export const ButtonText = forwardRef<HTMLButtonElement, React.ButtonHTMLAttributes<HTMLButtonElement>>(
  ({ className, ...props }, ref) => (
    <button
      ref={ref}
      className={cn(
